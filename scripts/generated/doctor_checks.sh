...
declare -a MANIFEST_CHECKS=(
    ...
    "stack.meta_skill.2	Local-first knowledge management with hybrid semantic search (ms)	ms doctor	required	target_user"
    ...
    "stack.ultimate_bug_scanner.2	UBS bug scanning (easy-mode)	cd /tmp && ubs doctor	required	target_user"
